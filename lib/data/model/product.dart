...
class Product extends Equatable {
  ...
  factory Product.fromEntity(Entity entity) {
    if (entity is ProductEntity) {
      ...
      } else if (entity.thumb.isNotEmpty) {
        images.add(CommerceImage(0, entity.thumb, ''));
      }

      List<ProductCategory> categories = [];
      if (entity.categories != null && entity.categories.isNotEmpty) {
        entity.categories.forEach((category) =>
            categories.add(ProductCategory(category.id, name: category.title)));
      }
      List<HashTag> hashTags = [];
      if (entity.hashTags != null && entity.hashTags.isNotEmpty) {
