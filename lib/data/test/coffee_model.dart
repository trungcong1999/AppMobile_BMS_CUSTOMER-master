...
final List<Coffee> coffeeShops = [
  Coffee(
      ...
      description:
          'Coffee bar chain offering house-roasted ',
  ...
  Coffee(
      ...
      description:
          'Small spot draws serious caffeine ',
  ...
  Coffee(
      ...
      description:
          'Snazzy, compact Japanese cafe showcasing ',
  ...
  Coffee(
      ...
      description:
          'Compact coffee & espresso bar turning out ',
