...
import 'package:hosco/presentation/widgets/independent/product_rating.dart';
...
extension View on Product {
    ...
    return BaseProductListItem(
      ...
      mainContentBuilder: (context) {
        return Column(
          ...
          children: <Widget>[
            Text(title.length > 25 ? title.substring(0, 25) + '...' : title, style: Theme.of(context).textTheme.display1),
          ...
          return Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(title != null ? (title.length > 20 ? title.substring(0, 20).toLowerCase() : title.toLowerCase() ) : '',
                  style: Theme.of(context).textTheme.headline4.copyWith(
                    fontSize: 13.0, height: 1.8
                  )),
              ),
              Row(
                children: <Widget>[
  ...
  Widget buildPrice(ThemeData _theme) {
    return Row(children: <Widget>[
      Text(
        price != null ? NumberFormat.currency(locale: AppSettings.locale, symbol: 'đ').format(price) /*'\$' + price.toStringAsFixed(0)*/ : '',
  ...
  Widget buildDiscountPrice(ThemeData _theme) {
    return Container( child: Text(NumberFormat.currency(locale: AppSettings.locale).format(discountPrice), //'\$' + discountPrice.toStringAsFixed(0),
        style: _theme.textTheme.display3.copyWith(
