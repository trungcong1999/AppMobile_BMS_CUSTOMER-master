...
import 'package:hosco/presentation/features/filters/accept_bottom_navigation.dart';
import 'package:hosco/presentation/widgets/independent/input_field.dart';
import 'package:hosco/presentation/widgets/independent/price_slider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          children: <Widget>[
            ...
            /*
                OpenFlutterPriceRangeSlider(
                  ...
                  label: 'Price range',
                  min: 0,
                  max: rules.selectedPriceRange.maxPrice, //300,
      ...
      bottomNavigationBar: AcceptBottomNavigation(
        onApply: () {
          print('call api to filter');
          print(rules.selectableAttributes);
