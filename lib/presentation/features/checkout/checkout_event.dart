...
@immutable
class SendOrderCardEvent extends CheckoutEvent {
  ...
  SendOrderCardEvent(this.deliveryPrice, this.fullname, this.address, this.mobile, this.description);

  @override
  List<Object> get props => [deliveryPrice, fullname, address, mobile, description];
}