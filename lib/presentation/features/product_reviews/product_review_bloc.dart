...
import 'package:hosco/data/model/product_review.dart';
import 'package:hosco/data/repositories/fake_repos/product_review_repository.dart';
...
class ProductReviewBloc extends Bloc<ProductReviewEvent, ProductReviewState> {
  ...
  Future<List<ProductReview>> _getCommentsReviews(
      String productId, bool withPhotos) async {
